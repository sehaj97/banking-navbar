...
function MainNavbar() {
  ...
  const [navigation, SetNavigation] = useState([
    ...
    { name: "Private Health", href: "privatehealth", current: false },
    { name: "Business", href: "business", current: false },
    { name: "Commercial", href: "commercial", current: false },
    { name: "Capital Markets", href: "capital-markets", current: false },
    { name: "Global Asset Management", href: "GAM", current: false },
  ]);
